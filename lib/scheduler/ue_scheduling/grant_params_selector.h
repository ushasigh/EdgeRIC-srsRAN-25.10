...
struct dl_sched_context {
  ...
  /// Expected number of RBs to allocate (before EdgeRIC weight adjustment).
  unsigned expected_nof_rbs;
  /// UE RNTI for EdgeRIC weight-based allocation.
  rnti_t rnti = rnti_t::INVALID_RNTI;
  /// Total available RBs in the BWP for EdgeRIC weight calculation.
  unsigned total_bwp_rbs = 0;
};
